...
export class InterComponentService {
  ...
  getButtonHeaderActive(): boolean {
      return this.buttonHeaderActive;
  }
  setButtonHeaderActive(value: boolean) {
      this.buttonHeaderActive = value;
  }
}
